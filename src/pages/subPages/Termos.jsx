...
function Termos() {
  return (
    ...
    <div  className='texto'>
        <p>Esta política de termos de uso é válida a partir de Sep 2024.</p>

        <p>TERMOS DE USO — Safe Solutions
Safe Solutions, pessoa jurídica de direito privado descreve, através deste documento, as regras de uso do site www.safesolutions.com e qualquer outro site, loja ou aplicativo operado pelo proprietário.
...
<p>Em geral, o acesso ao website da Safe Solutions possui caráter gratuito e não exige prévia inscrição ou registro.
...
A publicação de quaisquer conteúdos pelo usuário deste website, incluindo mensagens e comentários, implica em licença não-exclusiva, irrevogável e irretratável, para sua utilização, reprodução e
