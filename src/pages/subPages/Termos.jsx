...
function Termos() {
  return (
    ...
    <div  className='textoContent'>
        ...
        <p>TERMOS DE USO — Safe Solutions</p>
        <p>Safe Solutions, pessoa jurídica de direito privado descreve, através deste documento, as regras de uso do site www.safesolutions.com e qualquer outro site, loja ou aplicativo operado pelo proprietário.
...
Caso haja alteração significativa nos termos deste contrato, podemos informá-lo por meio das informações de contato que tivermos em nosso banco de dados ou por meio de notificações.
A utilização deste website após as alterações significa que você aceitou os Termos de Uso revisados. Caso, após a leitura da versão revisada, você não esteja de acordo com seus 
termos, favor encerrar o seu acesso. </p>
...
<p>Partes deste website oferecem ao usuário a opção de publicar comentários em determinadas áreas. Safe Solutions não consente com a publicação de conteúdos que tenham natureza discriminatória, ofensiva ou ilícita, ou ainda infrinjam direitos de autor ou quaisquer outros direitos de terceiros.</p>

<p>A publicação de quaisquer conteúdos pelo usuário deste website, incluindo mensagens e comentários, implica em licença não-exclusiva, irrevogável e irretratável, para sua utilização, reprodução e
 publicação pela Safe Solutions no seu website, plataformas e aplicações de internet, ou ainda em outras plataformas, sem qualquer restrição ou limitação.</p>
...
<p>Todos os elementos de Safe Solutions são de propriedade intelectual da mesma ou de seus licenciados. Estes Termos ou a utilização do website não concede a você qualquer licença ou direito de uso dos direitos de propriedade intelectual da Safe Solutions ou de terceiros. </p>
...
<p>O website no todo ou em cada uma das suas seções, pode ser encerrado, suspenso ou interrompido unilateralmente por Safe Solutions, a qualquer momento e sem necessidade de prévio aviso.</p>

<h5>Seção 8 - Dados pessoais</h5>

<p>urante a utilização deste website, certos dados pessoais serão coletados e tratados por Safe Solutions e/ou pelos Parceiros. As regras relacionadas ao tratamento de dados pessoais de Safe Solutions estão estipuladas na Política de Privacidade.</p>
